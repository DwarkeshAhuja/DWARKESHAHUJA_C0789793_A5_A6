package com.DwarkeshAhuja_C0789793_A5_A6;
...
public class Assignment_A5_A6 {
    ...
    public static void main(String[] args) {
        ...
        //cost.setServiceCostA();
        //cost.setServiceCostB();
        //cost.setOptionCostSmall();
        //cost.setOptionCostLarge();
        //cost.setItemBoxesSmall();
        //cost.setItemBoxesLarge();
        int j = 0;
        JOptionPane.showMessageDialog(null,"The user name and pass for login is\n" +
                "Dwarkesh And Ahuja");
        while (true){
            ...
            if(userName.equals("Dwarkesh") && userPass.equals("Ahuja")){
    ...
    private static double getStorageOption(double optionCostSmall, double optionCostLarge) {
        String servicePackage = JOptionPane.showInputDialog(null,
                "Please enter type of storage (S/L) you want from the following" +
    ...
    private static double getServicePackage(double costA, double costB) {
        String servicePackage = JOptionPane.showInputDialog(null,
                "Please enter type of service(A/B) you want from the following" +
